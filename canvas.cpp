...
Canvas::Canvas(const char* nome, vector<Point*> coordenadas) : Object(nome, coordenadas) {
}

void Canvas::clipping(Window window, Viewport viewport) {
}

void Canvas::draw(Viewport viewport, Window window, cairo_t *cr, int clippingType) {
