...
Object::Object(const char* nome, vector<Point*> coordenadas) {
    this->nome = nome;
    this->coordenadas = coordenadas;
}

Object::Object(const char* nome) {
    this->nome = nome;
}
...
void Object::drawNormalized(Window window) {
...
void Object::translate(int entryX, int entryY, int entryZ) {
    Matrix3D m;
...
void Object::scale(float entryX, float entryY, float entryZ) {
...
void Object::rotate(int angX, int angY, int angZ) {
...
void Object::rotateUsingCoordinate(int ang, float entryX, float entryY) {
...
vector<Point*> Object::ortogonalize(Window window) {
