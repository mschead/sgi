...
SurfaceSplineFD::SurfaceSplineFD(const char* nome, vector<Point*> coordenadas,
...
void SurfaceSplineFD::drawCurveInT(float DDX[4][4], float DDY[4][4], float DDZ[4][4]) {
...
void SurfaceSplineFD::drawCurveInS(float DDX[4][4], float DDY[4][4], float DDZ[4][4]) {
...
void SurfaceSplineFD::drawCurveFwdDiff(float pontosFwdX[4], float pontosFwdY[4], float pontosFwdZ[4], int vector, bool usingVectorsT) {
...
void SurfaceSplineFD::draw(Viewport viewport, Window window, cairo_t *cr, int clippingType) {
    auxLines.clear();
...
void SurfaceSplineFD::clipping(Window window, Viewport viewport) {
