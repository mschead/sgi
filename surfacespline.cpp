...
SurfaceSpline::SurfaceSpline(const char* nome, vector<Point*> coordenadas,
...
void SurfaceSpline::clipping(Window window, Viewport viewport) {
    // método de clippagem da reta invocado
}

void SurfaceSpline::draw(Viewport viewport, Window window, cairo_t *cr, int clippingType) {
    auxLines.clear();
