...
BezierSpline3D::BezierSpline3D(char* nome, vector<Point*> coordenadas,
...
void BezierSpline3D::clipping(Window window, Viewport viewport) {
    // método de clippagem da reta invocado
}

void BezierSpline3D::draw(Viewport viewport, Window window, cairo_t *cr, int clippingType) {
    auxLines.clear();
